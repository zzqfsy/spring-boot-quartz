...
DROP TABLE IF EXISTS qrtz_record_job;
DROP TABLE IF EXISTS qrtz_record_execute;
...
CREATE TABLE `qrtz_record_execute` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `SCHED_NAME` varchar(120) DEFAULT NULL,
  `JOB_NAME` varchar(200) DEFAULT NULL,
  `JOB_GROUP` varchar(200) DEFAULT NULL,
  ...
  `execute_result` varchar(5000) DEFAULT NULL,
  `callback_result` varchar(5000) DEFAULT NULL,
  `add_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
